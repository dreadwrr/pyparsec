...
Returns a list of tuples for all active entries on the volume. This can be used to find new or modified files faster
than other methods as it doesnt have to walk the file system.
